...
export default function AttendancePage() {
  ...
  const classList: any[] = useMemo(() => Array.isArray(classes) ? classes : [], [classes]);
  const sectionList: any[] = useMemo(() => Array.isArray(allSections) ? allSections : [], [allSections]);
  const filtered = useMemo(
    () => selectedClass ? sectionList.filter((s: any) => s.classId === selectedClass) : sectionList,

...
export default function ParentAnnouncementsPage() {
  ...
  return (
    <div className="p-6 space-y-5">
      <div>
        <h1 className="text-2xl font-black text-gray-900">School Announcements</h1>
        <p className="text-gray-500 text-sm">Notices from school management</p>
      </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      <span className="text-[10px] text-gray-400 font-medium">{a.audience || 'ALL'}</span>
                    </div>

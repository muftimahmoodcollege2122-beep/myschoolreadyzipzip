...
let AuthController = class AuthController {
    ...
    login(dto, req) {
        ...
        const slug = dto.tenantSlug || req.tenantContext?.tenantId || 'demo';
        return this.svc.loginBySlug(dto, slug, ip, ua);
    }
    refresh(dto, req) {
        const tid = req.tenantContext?.tenantId ?? req.headers['x-tenant-id'] ?? '';
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Logout and revoke session' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, tenant_id_decorator_1.TenantId)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [login_dto_1.LogoutDto, Object, String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, tenant_id_decorator_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: 'Self-service school registration — creates tenant + admin user' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
